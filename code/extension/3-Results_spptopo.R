...
print("Running results checking for effects of potential topological differences between genus and species phylogenies...")
remove(list = ls())
...
eCor.res
write.csv(eCor.res, paste0(output.dir, "EvoCorr_multiModels_sppTopo.csv"), row.names = F)
print(paste("==>", output.dir, "EvoCorr_multiModels_sppTopo.csv"))

signEco <- singEcoFun(eCor.res)
signEco
write.csv(signEco, paste0(output.dir, "SignEvoCorr_multiModels_sppTopo.csv"), row.names = F)
print(paste("==>", output.dir, "SignEvoCorr_multiModels_sppTopo.csv"))
